...
const experimentsData = [
  { id: 1, meta: '10M', data: '20/05/2025', horario: '16:00', status: 'Falha' },
  { id: 2, meta: '20M', data: '22/05/2025', horario: '16:00', status: 'Sucesso' },
  { id: 3, meta: '5M', data: '23/05/2025', horario: '10:30', status: 'Em Andamento' },
  { id: 4, meta: '50M', data: '28/05/2025', horario: '19:00', status: 'Sucesso' },
  { id: 5, meta: '15M', data: '30/05/2025', horario: '11:00', status: 'Falha' },
  { id: 6, meta: '100M', data: '02/06/2025', horario: '09:00', status: 'Agendado' },
];
                ...
                <tr key={exp.id} className="border-b border-gray-800 hover:bg-slate-800/50">
                  ...
                  <td className="py-4 px-4">
                    <div className="flex items-center justify-center gap-2">
                      <button className="bg-green-600 text-white text-xs font-bold py-2 px-5 rounded-full hover:bg-green-700 transition-colors duration-200">
                        VER
                      </button>
